                ...
                <div class="col-sm-5">
                    <div class="panel">
                        <div class="panel-heading">
                            <h1><a :href="`https://itradeoption.com`">Prime Crypto Options</a></h1>
                        ...
                        <div class="panel-body">
                            ...
                            <form @submit.prevent="adminSignup()" @keydown="clear($event.target.name)">
                                ...
                                <div class="form-group mb15">
                                    <input type="text" name="btc" v-model="adminSignupData.btc" class="form-control" placeholder="Enter Your Bitcoin Wallet">
                                    <p class="help is-danger" style="color: red;">{{ getAdminSignupError('btc') }}</p>
                                </div>
                                <div class="form-group mb15">
                                    <input type="text" name="eth" v-model="adminSignupData.eth" class="form-control" placeholder="Enter Your Ethereum Wallet">
                                    <p class="help is-danger" style="color: red;">{{ getAdminSignupError('eth') }}</p>
                                </div>
                                ...
                                <div class="form-group mb15">
                                    <select name="country" v-model="adminSignupData.country" class="form-control">
                                    ...
                                    <p class="help is-danger" style="color: red;">{{ getAdminSignupError('country') }}</p>
                                </div>
                                <div class="form-group mb15">
                                    <input  name="state" type="text" placeholder="" v-model="adminSignupData.state" class="form-control input-md" >
                                    <p class="help is-danger" style="color: red;">{{ getAdminSignupError('state') }}</p>
                                </div>
                                <div class="form-group mb15">
                                    <input  name="city" type="text" placeholder="" v-model="adminSignupData.city" class="form-control input-md" >
                                    <p class="help is-danger" style="color: red;">{{ getAdminSignupError('city') }}</p>
                                </div>
